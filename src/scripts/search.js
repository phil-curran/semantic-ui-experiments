    ...
    templates: {
      ...
      message: function (message, type) {
        ...
        if (message !== undefined && type !== undefined) {
          html += `<div className="message ' + ${type} + '">' + message + "</div>";`;
          // message type
          if (type === "empty") {
            html +=
              "" +
              '<div className="header">No Results</div className="header">' +
            ...
            if (
              ...
              $.each(category.results, function (index, result) {
                if (result[fields.url]) {
                  html +=
                    '<a className="result" href="' + result[fields.url] + '">';
                } else {
                  html += '<a className="result">';
                }
      ...
      standard: function (response, fields) {
        ...
        if (response[fields.results] !== undefined) {
          ...
          $.each(response[fields.results], function (index, result) {
            ...
            if (result[fields.price] !== undefined) {
              html +=
                '<div className="price">' + result[fields.price] + "</div>";
            }
            if (result[fields.title] !== undefined) {
              html +=
                '<div className="title">' + result[fields.title] + "</div>";
            }
            if (result[fields.description] !== undefined) {
              html +=
                '<div className="description">' +
