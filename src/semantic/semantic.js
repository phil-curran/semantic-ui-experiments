      ...
      module = {
        ...
        is: {
          ...
          fieldDirty: function ($el) {
            ...
            var isBoolValue =
              boolRegex.test(initialValue) && boolRegex.test(currentValue);
            if (isBoolValue) {
        ...
        get: {
          ...
          field: function (identifier) {
            ...
            if (
              (t = $field.filter('[name="' + identifier + '[]"]')).length > 0
            ) {
              return t;
            }
            if (
          ...
          values: function (fields) {
            var $fields = Array.isArray(fields)
        ...
        add: {
          ...
          fields: function (fields) {
            validation = $.extend(
              {},
              validation,
              module.get.fieldsFromShorthand(fields)
            );
          },
        ...
        remove: {
          ...
          rule: function (field, rule) {
            ...
            if (
              ...
              !Array.isArray(validation[field].rules)
            ) {
              return;
            }
            if (rule === undefined) {
          ...
          autoCheck: function () {
            ...
            $field.each(function (_index, el) {
              var $el = $(el),
                ...
                isRequired =
                  $el.prop("required") ||
                  $elGroup.hasClass(className.required) ||
                  $elGroup.parent().hasClass(className.required),
                isDisabled =
                  $el.is(":disabled") ||
                  $elGroup.hasClass(className.disabled) ||
                  $elGroup.parent().hasClass(className.disabled),
            ...
            if (isDisabled) {
              ...
              $.each(field.rules, function (index, rule) {
                if (module.has.field(identifier)) {
                  var invalidFields =
                    module.validate.rule(field, rule, true) || [];
              ...
              isValid = function (field) {
                ...
                value =
                  value === undefined || value === "" || value === null
                    ? ""
                    : (settings.shouldTrim && rule.shouldTrim !== false) ||
                      rule.shouldTrim
                    ? String(value + "").trim()
                    : String(value + "");
  ...
  $.fn.form.settings = {
    ...
    rules: {
      ...
      match: function (value, identifier, $module) {
        ...
        if (
          (matchingElement = $module.find(
            '[data-validate="' + identifier + '"]'
          )).length > 0
        ) {
          matchingValue = matchingElement.val();
        } else if (
          (matchingElement = $module.find("#" + identifier)).length > 0
        ) {
          matchingValue = matchingElement.val();
        } else if (
...
(function ($, window, document, undefined) {
      ...
      module = {
        ...
        setup: {
          config: function () {
            ...
            module.setting(
              "on",
              settings.on || ($input.length ? "focus" : "click")
            );
          },
          popup: function () {
            if (settings.inline) {
        ...
        create: {
          calendar: function () {
            ...
            var mode = module.get.mode(),
              ...
              display = module.helper.dateInRange(
                focusDate || date || settings.initialDate || today
              );
            if (!focusDate) {
              focusDate = display;
            ...
            var tooltipPosition = container.hasClass("left")
              ? "right center"
              : "left center";
            container.empty();
            if (pages > 1) {
            ...
            for (p = 0; p < pages; p++) {
              ...
              var table = $("<table/>")
                ...
                .addClass(tempMode)
                .addClass(numberText[columns] + " column")
                .appendTo(container);
              if (isInverted) {
              ...
              for (r = 0; r < rows; r++) {
                ...
                for (c = 0; c < textColumns; c++, i++) {
                  ...
                  var eventDate;
                  if (disabled) {
                    var disabledDate = module.helper.findDayAsObject(
                      cellDate,
                      mode,
                    ...
                    if (
                      ...
                      cell.attr(
                        "data-position",
                        disabledDate[metadata.position] || tooltipPosition
                      );
                      if (
                        disabledDate[metadata.inverted] ||
                        (isInverted &&
                          disabledDate[metadata.inverted] === undefined)
                      ) {
                      ...
                      if (disabledDate[metadata.variation]) {
                        cell.attr(
                          "data-variation",
                          disabledDate[metadata.variation]
                        );
                      }
                    }
                  } else {
                    eventDate = module.helper.findDayAsObject(
                      cellDate,
                      mode,
                      settings.eventDates
                    );
                    if (eventDate !== null) {
                      ...
                      if (eventDate[metadata.message]) {
                        ...
                        cell.attr(
                          "data-position",
                          eventDate[metadata.position] || tooltipPosition
                        );
                        if (
                          eventDate[metadata.inverted] ||
                          (isInverted &&
                            eventDate[metadata.inverted] === undefined)
                        ) {
                          cell.attr("data-inverted", "");
                        }
                  ...
                  cell.toggleClass(
                    className.adjacentCell,
                    adjacent && !eventDate
                  );
                  cell.toggleClass(className.disabledCell, disabled);
                  cell.toggleClass(
                    className.activeCell,
                    active && !(adjacent && disabled)
                  );
                  if (!isHour && !isMinute) {
        ...
        refreshTooltips: function () {
          ...
          $container.find("td[data-position]").each(function () {
            var cell = $(this);
            var tooltipWidth = window
              .getComputedStyle(cell[0], ":after")
              .width.replace(/[^0-9\.]/g, "");
            var tooltipPosition = cell.attr("data-position");
            // use a fallback width of 250 (calendar width) for IE/Edge (which return "auto")
            var calcPosition =
              winWidth - cell.width() - (parseInt(tooltipWidth, 10) || 250) >
              cell.offset().left
                ? "right"
                : "left";
            if (tooltipPosition.indexOf(calcPosition) === -1) {
              cell.attr(
                "data-position",
                tooltipPosition.replace(/(left|right)/, calcPosition)
              );
            }
          });
        },
        ...
        set: {
          ...
          focusDate: function (
            ...
            var changed = module.set.dataKeyValue(
              metadata.focusDate,
              date,
              !!date && refreshCalendar
            );
            updateFocus =
                  ...
                  if (d !== null && typeof d === "object") {
                    if (d[metadata.year]) {
                      ...
                      if (typeof d[metadata.month] === "number") {
                        ...
                        var sdate = module.helper.sanitiseDate(
                          d[metadata.month]
                        );
                        return (
              ...
              for (var i = 0; i < dates.length; i++) {
                ...
                if (
                  ...
                  if (d[metadata.year]) {
                    ...
                    if (
                      d[metadata.date] instanceof Date &&
                      ...
                      if (
                        d[metadata.date].some(function (idate) {
                          return module.helper.dateEqual(date, idate, mode);
                        })
                      ) {
                        return d;
  ...
  $.fn.calendar.settings = {
    ...
    startCalendar: null, // $ object or selector for another calendar that represents the start date of a date range
    endCalendar: null, // $ object or selector for another calendar that represents the end date of a date range
    ...
    parser: {
      date: function (text, settings) {
        ...
        text =
          settings.monthFirst || !text.match(/^[0-9]{1,2}[\/\-\.]/)
            ? text
            : text
                .replace(/[\/\-\.]/g, "/")
                .replace(/([0-9]+)\/([0-9]+)/, "$2/$1");
      ...
      module = {
        ...
        event: {
          ...
          keydown: function (event) {
            ...
            if (!module.should.ignoreCallbacks() && checkIndex !== false) {
              ...
              if (
                settings.beforeChecked.apply(
                  $(r[checkIndex]).children(selector.input)[0]
                ) === false
              ) {
                module.verbose(
        ...
        should: {
          allowCheck: function () {
            ...
            if (
              !module.should.ignoreCallbacks() &&
              settings.beforeChecked.apply(input) === false
            ) {
          ...
          allowUncheck: function () {
            ...
            if (
              !module.should.ignoreCallbacks() &&
              settings.beforeUnchecked.apply(input) === false
            ) {
              module.debug(
          ...
          allowIndeterminate: function () {
            ...
            if (
              !module.should.ignoreCallbacks() &&
              settings.beforeIndeterminate.apply(input) === false
            ) {
              module.debug(
          ...
          allowDeterminate: function () {
            ...
            if (
              !module.should.ignoreCallbacks() &&
              settings.beforeDeterminate.apply(input) === false
            ) {
              module.debug(
      ...
      module = {
          ...
          show: function (callback) {
            ...
            if (
              ...
              $dimmer.transition({
                ...
                animation:
                  (settings.transition.showMethod || settings.transition) +
                  " in",
                queue: false,
          ...
          hide: function (callback) {
            ...
            if (
              ...
              $dimmer.transition({
                displayType: settings.useFlex ? "flex" : "block",
                animation:
                  (settings.transition.hideMethod || settings.transition) +
                  " out",
                queue: false,
                duration: module.get.duration(),
                useFailSafe: true,
        ...
        get: {
          ...
          duration: function () {
            if (module.is.active()) {
              return (
                settings.transition.hideDuration ||
                settings.duration.hide ||
                settings.duration
              );
            } else {
              return (
                settings.transition.showDuration ||
                settings.duration.show ||
                settings.duration
              );
            }
          },
      ...
      module = {
        ...
        search: function (query) {
          ...
          if (settings.fireOnInit === false && module.is.initialLoad()) {
            module.verbose(
              "Skipping callback on initial load",
              settings.onSearch
            );
          } else if (
            module.has.minCharacters(query) &&
            settings.onSearch.call(element, query) !== false
          ) {
            module.filter(query);
          } else {
                ...
                if (!Array.isArray(preSelected)) {
                  preSelected =
                    preSelected && preSelected !== ""
                      ? preSelected.split(settings.delimiter)
                      : [];
                }
                if (module.is.multiple()) {
          ...
          var apiSettings = {
            ...
            onSuccess: function (response) {
              ...
              if (values.length === 0 && !settings.allowAdditions) {
                ...
                var value = module.is.multiple()
                  ? module.get.values()
                  : module.get.value();
                if (value !== "") {
                  module.verbose(
                    "Value(s) present after click icon, select value(s) in items"
                  );
          ...
          if (module.has.query()) {
            ...
            $item.each(function () {
              ...
              if (settings.match === "both" || settings.match === "value") {
                value = module.remove.diacritics(
                  String(module.get.choiceValue($choice, text))
                );
            ...
            $divider
              ...
              .filter(function () {
                ...
                return (
                  ...
                  (lastDivider.length ? lastDivider : $(this))
        ...
        event: {
          ...
          test: {
            toggle: function (event) {
              ...
              if (
                !module.is.multiple() ||
                (module.is.multiple() && !module.is.active())
              ) {
                focused = true;
              }
            ...
            keydown: function (event) {
              ...
              if (isShortcutKey) {
                var $label = $module.find(selector.label),
                  ...
                  caretAtStart =
                    isFocusedOnSearch && module.get.caretPosition(false) === 0,
                  isSelectedSearch =
                    caretAtStart && module.get.caretPosition(true) !== 0,
                  $nextLabel;
        ...
        determine: {
          ...
          eventOnElement: function (event, callback) {
            var $target = $(event.target),
              ...
              notOnLabel =
                $module.find($label).length === 0 ||
                !(module.is.multiple() && settings.useLabels),
        ...
        can: {
          ...
          openDownward: function ($subMenu) {
            ...
            if (module.has.subMenu($currentMenu)) {
              calculations.menu.height += $currentMenu
                .find(selector.menu)
                .first()
                .outerHeight();
            }
        ...
        animate: {
          show: function (callback, $subMenu) {
            ...
            transition =
              settings.transition.showMethod || module.get.transition($subMenu);
            ...
            if (
              ...
              if (transition === "none") {
                ...
                $currentMenu.transition({
                  ...
                  verbose: settings.verbose,
                  duration:
                    settings.transition.showDuration || settings.duration,
                  queue: true,
                  onStart: start,
                  displayType: module.get.displayType(),
                  onComplete: function () {
          ...
          hide: function (callback, $subMenu) {
            var $currentMenu = $subMenu || $menu,
              ...
              transition =
                settings.transition.hideMethod ||
                module.get.transition($subMenu);
            callback = $.isFunction(callback) ? callback : function () {};
            if (
              ...
              if (transition === "none") {
                ...
                $currentMenu.transition({
                  ...
                  duration:
                    settings.transition.hideDuration || settings.duration,
                  debug: settings.debug,
                  verbose: settings.verbose,
                  queue: false,
                  onStart: start,
        ...
        if (itemType === "item" || isMenu) {
          ...
          html +=
            ...
            (option[fields.class]
              ...
              : className.item) +
            '" data-value="' +
            deQuote(option[fields.value], true) +
            '"' +
            maybeText +
            ">";
          if (isMenu) {
...
(function ($, window, document, undefined) {
  ...
  $.fn.modal = function (parameters) {
    ...
    $allModules.each(function () {
      var settings = $.isPlainObject(parameters)
        ...
        $dimmer,
        element = this,
        instance = $module.hasClass("modal")
          ? $module.data(moduleNamespace)
          : undefined,
        ...
        initialize: function () {
          ...
          if (settings.title !== "") {
            $module
              .find(selector.title)
              .html(
                module.helpers.escape(settings.title, settings.preserveHTML)
              )
              .addClass(settings.classTitle);
          }
          if (settings.content !== "") {
            $module
              .find(selector.content)
              .html(
                module.helpers.escape(settings.content, settings.preserveHTML)
              )
              .addClass(settings.classContent);
          }
          if (module.has.configActions()) {
            var $actions = $module
              .find(selector.actions)
              .addClass(settings.classActions);
            if ($actions.length === 0) {
              $actions = $("<div/>", {
        ...
        event: {
          ...
          mouseup: function (event) {
            ...
            if (
              ...
              isInDOM &&
              module.is.active() &&
              $module.hasClass(className.front)
            ) {
          ...
          if (module.is.animating() || module.is.active()) {
            if (
              ...
              $module.transition({
                ...
                onStart: function () {
                  if (
                    !module.others.active() &&
                    !module.others.animating() &&
                    !keepDimmed
                  ) {
                    module.hideDimmer();
                  }
          ...
          bodyMargin: function () {
            ...
            $body
              ...
              .each(function () {
                ...
                el.css(
                  attribute,
                  "calc(" + el.css(attribute) + " + " + tempBodyMargin + "px)"
                );
              });
          },
          clickaway: function () {
        ...
        if (instance === undefined) {
          if ($.isFunction(settings.templates[query])) {
            ...
            settings = $.extend(
              ...
              {},
              settings,
              settings.templates[query].apply(module, queryArguments)
            );
  ...
  $.fn.modal.settings = {
    ...
    selector: {
      ...
      dimmer: "> .ui.dimmer",
      bodyFixed:
        "> .ui.fixed.menu, > .ui.right.toast-container, > .ui.right.sidebar, > .ui.fixed.nag, > .ui.fixed.nag > .close",
  ...
  $.fn.modal.settings.templates = {
    ...
    prompt: function () {
      ...
      if (input.length === 0) {
        args.content +=
          '<p><div class="' +
          settings.className.prompt +
          '"><input placeholder="' +
          this.helpers.deQuote(args.placeholder || "") +
          '" type="text" value="' +
          this.helpers.deQuote(args.defaultValue || "") +
          '"></div></p>';
      }
      return {
        title: args.title,
        ...
        actions: [
          {
            ...
            click: function () {
              var settings = $this.get.settings(),
                inputField = $this.get
                  .element()
                  .find(settings.selector.prompt)[0];
      ...
      module = {
        ...
        show: function () {
          if (module.should.show() && !$module.is(":visible")) {
            if (settings.onShow.call(element) === false) {
              module.debug(
                "onShow callback returned false, cancelling nag animation"
              );
              return false;
            }
        ...
        hide: function () {
          if (settings.onHide.call(element) === false) {
            module.debug(
              "onHide callback returned false, cancelling nag animation"
            );
            return false;
          }
        ...
        storage: {
          set: function (key, value) {
            ...
            if (storage === window.localStorage && options.expires) {
              module.debug(
                "Storing expiration value in localStorage",
                key,
                options.expires
              );
          ...
          get: function (key) {
            ...
            if (storage === window.localStorage) {
              ...
              if (
                ...
                module.debug(
                  "Value in localStorage has expired. Deleting key",
                  key
                );
      ...
      module = {
        helper: {
          sum: function (nums) {
            return Array.isArray(nums)
              ? nums.reduce(function (left, right) {
        ...
        get: {
          text: function (templateText, index) {
            var index_ = index || 0,
              ...
              left =
                total !== false ? Math.max(0, total - value) : 100 - percent;
          ...
          value: function (index) {
            return (
              module.nextValue ||
              (module.value && module.value[index || 0]) ||
              0
            );
          },
          total: function () {
        ...
        set: {
          ...
          percent: function (percents) {
            ...
            var sumTotal = module.helper.sum(
              module.helper.forceArray(module.value)
            );
            if (isMultipleValues && sumTotal > module.total) {
              ...
              var autoPrecision =
                settings.precision > 0
                  ...
                  ? module.helper.derivePrecision(
                      Math.min.apply(null, module.value),
                      module.total
                    )
                  : 0;
              ...
              var roundedPercents = percents.map(function (percent) {
                return autoPrecision > 0
                  ? Math.round(percent * (10 * autoPrecision)) /
                      (10 * autoPrecision)
                  : Math.round(percent);
              });
              ...
              if (hasTotal) {
                module.value = percents.map(function (percent) {
                  return autoPrecision > 0
                    ? Math.round(
                        (percent / 100) * module.total * (10 * autoPrecision)
                      ) /
                        (10 * autoPrecision)
        ...
        update: {
          ...
          progress: function (values) {
            ...
            var percentCompletes = module.helper
              .forceArray(values)
              .map(function (value) {
                var percentComplete;
                ...
                if (hasTotal) {
                  percentComplete =
                    module.total > 0 ? (value / module.total) * 100 : 100;
                  module.debug(
          ...
          numLabels: function () {
            var value = Math.round(
              (module.get.max() - module.get.min()) /
                (module.get.step() === 0 ? 1 : module.get.step())
            );
            module.debug(
          ...
          label: function (value) {
            ...
            switch (settings.labelType) {
              case settings.labelTypes.number:
                return (
                  Math.round(
                    (value * (module.get.step() === 0 ? 1 : module.get.step()) +
                      module.get.min()) *
                      precision
                  ) / precision
                );
          ...
          position: function (newValue, $element) {
            ...
            var trackPosValue,
              ...
              trackStartPosPercent =
                (100 * (Math.min(thumbVal, secondThumbVal) - min)) /
                (max - min),
              trackEndPosPercent =
                100 *
      ...
      module = {
        ...
        stage: {
          ...
          right: function () {
            ...
            module.verbose(
              "Setting the initial animation position as right",
              $nextSide,
              box
            );
            $activeSide.css({
...
(function ($, window, document, undefined) {
      ...
      module = {
        initialize: function () {
          ...
          if (
            ...
            module.changeTab(
              settings.autoTabActivation === true
                ? module.get.initialPath()
                : settings.autoTabActivation
            );
          }
  ...
  $.fn.tab.settings = {
    ...
    error: {
      ...
      state:
        "History requires Asual's Address library <https://github.com/asual/$-address>",
    },
      ...
      module = {
          ...
          toast: function () {
            ...
            if (!isToastComponent) {
              ...
              if (iconClass !== "") {
                $toast
                  .find(selector.icon)
                  .attr("class", iconClass + " " + className.icon);
              }
              if (settings.showImage) {
                  ...
                  if (settings.transition.closeEasing !== "") {
                    if ($toastBox) {
                      ...
                      $toastBox
                        ...
                        .parent()
                        .hide(
                          settings.transition.closeDuration,
        ...
        has: {
          container: function () {
            ...
            return (
              $context.find(
                module.helpers.toClass(settings.position) +
                  selector.container +
                  (settings.horizontal
...
(function ($, window, document, undefined) {
    ...
    $allModules.each(function () {
      ...
      module = {
        ...
        query: function () {
          ...
          // look for $ ajax parameters in settings
  ...
  $.api.settings = {
    ...
    error: {
      ...
      missingSerialize:
        "$-serialize-object is required to add form data to an existing data object",
